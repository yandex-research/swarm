...
from src.averaging.partition import AllreduceException, TensorPartContainer, TensorPartReducer
from src.compression import deserialize_torch_tensor, serialize_torch_tensor
from src.p2p import P2P, P2PContext, PeerID, ServicerBase, StubBase
from src.proto import averaging_pb2
from src.utils import get_logger
from src.utils.asyncio import achain, aenumerate, afirst, amap_in_executor, anext, as_aiter
...
class AllReduceRunner(ServicerBase):
    ...
    This class inherits src.p2p.ServicerBase, so it can be used as an RPCServicer for testing purposes without
    ...
    :param p2p: a src.p2p.P2P instance used for communication with other peers
    :param servicer_type: a src.p2p.ServicerBase subclass whose RPC signatures are used
