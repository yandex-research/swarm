...
from src.proto.auth_pb2 import AccessToken, RequestAuthInfo, ResponseAuthInfo
from src.utils.crypto import RSAPrivateKey, RSAPublicKey
from src.utils.logging import get_logger
from src.utils.timed_storage import TimedStorage, get_dht_time
...
class TokenAuthorizerBase(AuthorizerBase):
    """
    Implements the authorization protocol for a moderated network
    """
