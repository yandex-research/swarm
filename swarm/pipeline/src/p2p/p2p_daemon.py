...
import src.src_cli as cli
import src.p2p.p2p_daemon_bindings.p2pclient as p2pclient
from src.p2p.p2p_daemon_bindings.control import DEFAULT_MAX_MSG_SIZE, P2PDaemonError, P2PHandlerError
from src.p2p.p2p_daemon_bindings.datastructures import PeerID, PeerInfo, StreamInfo
from src.proto.p2pd_pb2 import RPCError
from src.utils.asyncio import as_aiter, asingle
from src.utils.logging import get_logger, golog_level_to_python, loglevel, python_level_to_golog
...
class P2P:
    ...
    _UNIX_SOCKET_PREFIX = "/unix/tmp/src-"
