...
import src
from src.compression.base import CompressionBase, CompressionInfo, Key, NoCompression, TensorRole
...
class AdaptiveCompressionBase(CompressionBase, ABC):
    ...
    def extract(self, serialized_tensor: runtime_pb2.Tensor) -> torch.Tensor:
        return src.compression.deserialize_torch_tensor(serialized_tensor)
