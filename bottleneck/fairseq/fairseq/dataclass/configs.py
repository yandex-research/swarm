...
class CommonConfig(FairseqDataclass):
    ...
    rdm_type : str = field(default='full', metadata={"help": "Use bnb optimizers if available."},)
    l1 : float = field(default=0.0, metadata={"help": "Use bnb optimizers if available."},)


    fused: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    adam_bits: int = field(default=32,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    adam8bits_offset: float = field(default=0.001953125,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    adam8bits_qfreq: int = field(default=1,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    adam8bits_method: str = field(default='dynamic_tree',metadata={"help": "The quantization method: Default: quantile. Options: {quantile, dynamic_tree}"},)
    swapped_adam: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    unorm: str = field(default='none',metadata={"help": "The update norm scaling method: Default: none. Options: {scale, percentile}"},)
    dbuffer: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    prob_quant: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    update_guard: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    cola: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    dist_scale: float = field(default=1.0,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    dummy: str = field(
        default='', metadata={"help": "Dummy variable to track arbitrary data in the config."}
    )
    emb_max_norm: float = field(default=0.0,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    adam8bits_wdecay: float = field(default=0.0,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
