...
class TransformerLanguageModelConfig(FairseqDataclass):
    ...
    ff_block : str = field(default='ff', metadata={"help": "The type of FF Block. Choices: {ff, adaptive_ff}"},)
    adaptive_lossw : float = field(default=1e-6, metadata={"help": "The adaptive loss."},)
    adaptive_ramp : float = field(default=0.25, metadata={"help": "Percentage of the layer used as the adaptive ramp."},)
    adaptive_init : float = field(default=0.0, metadata={"help": "Init value of the adaptive vector."},)
    target_sparsity : float = field(default=0.90, metadata={"help": "The desired final sparsity."},)
    str_loss : float = field(default=0.0, metadata={"help": "The sparse reparametrization loss."},)
    str_type : str = field(default='vector', metadata={"help": "The sparse reparametrization loss."},)
    str_progress_start : float = field(default=0.0, metadata={"help": "The sparse reparametrization loss."},)
    str_lr: float = field(default=0.0,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    str_mult_offset: float = field(default=0.01,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    str_noisy_relu: float = field(default=0.0,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    str_weight_noise: float = field(default=0.0,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    str_sparse: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    str_func: str = field(default='logistic',metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    base_hidden_dim: int = field(default=0,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    base_init: str = field(default='zero',metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    stable_emb : bool = field(default=False, metadata={"help": "Use bnb optimizers if available."},)
    training: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    init: str = field(default='pytorch',metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    use_8bit_training: str = field(default='off',metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    quant_type: str = field(default='vector',metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    str_init : float = field(default=-10.0, metadata={"help": "Use bnb optimizers if available."},)
    update_freq : List[int] = II("optimization.update_freq")
    max_update : int = II("optimization.max_update")
    trim : float = field(default=3.0, metadata={"help": "Use bnb optimizers if available."},)
    dloss : float = field(default=0.0, metadata={"help": "Use bnb optimizers if available."},)
    topk: int = field(default=8,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    dendrite_type: str = field(default='vec',metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    dim3: int = field(default=32,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    branch_size: int = field(default=4,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    no_relu: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    exponent_bits: int = field(default=7,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    attention_8bit: str = field(default='off',metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    maxout: int = field(default=1,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    scale_factor: int = field(default=2,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    attention_norm: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    attention_init: str = field(default='xavier',metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
    init_value: float = field(default=1.0, metadata={"help": "Use bnb optimizers if available."},)
    num_stages: int = field(default=0, metadata={"help": "Use bnb optimizers if available."},)
    comm8bit: bool = field(default=False,metadata={"help": "scalar quantization noise and scalar quantization at training time"},)
...
class TransformerLanguageModel(FairseqLanguageModel):
    ...
    def build_embedding(cls, args, dictionary, embed_dim, path=None):
        if not args.stable_emb:
            embed_tokens = Embedding(len(dictionary), embed_dim, dictionary.pad())
        else:
            if not args.no_scale_embedding:
                print('Stable embedding requires the --no-scale-embedding flag')
                raise ValueError('Stable embedding requires the --no-scale-embedding flag')
            embed_tokens = bnb.nn.StableEmbedding(len(dictionary), embed_dim, dictionary.pad())
